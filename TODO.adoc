...
* Backend.
  ** [x] Send email on successful reservations.
  ** [x] `/space/view` route should return 404 when there is no such space.
  ** [ ] File uploads.
    *** [x] Profile pictures.
    *** [x] Space pictures.
    *** [ ] Desk pictures.
...
* Frontend.
  ...
  ** [x] Add QR code generator for URLs to join space.
  ** [ ] Light/Dark mode.
  ...
  ** [ ] Filter "Your Reservations".
    *** [ ] Filter by space.
  ** [x] Show more info for spaces in "Your Dashboard" and "Browse Spaces"
    *** [ ] City.
    *** more?
...
* [x] Space invites.
  ** [x] Create invite URLs.
  ** [x] Sign in/up without redirect to login page.
